...
<section class="content-header">
    <h1>Agregar nueva Recomendación/Meta</h1>
</section>
<!-- search container -->
            ...
            <form id="form_edita_plan">
              <div class="col-md-3">
                <div class="form-group">
                  <label for="">Tipo: <small><p class="obligatorio">*</p></small></label>
                  <br>

                  <input type="radio" id="opcion_uno" name="tipo" value="Recomendación">
                  <label for="opcion_uno">Recomendación</label>
                  &nbsp;&nbsp;&nbsp;
                  <input type="radio" id="opcion_dos" name="tipo" value="Meta">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <label for="procedencia">Procedencia <small><p class="obligatorio">*</p></small></label>
              ...
              <div class="col-md-3">
                <div class="form-grup">
                  <label for="plan_no">Plan no. <small><p class="obligatorio">*</p></small></label>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <label for="fecha_creacion">Fecha <small><p class="obligatorio">*</p></small></label>
                  <input type="text" name="fecha_creacion" id="fecha_creacion" class="form-control" value="{{ date('Y-m-d') }}" readonly>
                </div>
              </div>

              <div class="col-md-3">
                <div class="form-group">
                  <label for="cantidad">Cantidad <small><p class="obligatorio">*</p></small></label>
              ...
              <div class="col-md-3" hidden>
                <div class="form-group">
                  <label for="orden">Orden <small><p class="obligatorio">*</p></small></label>
                  <input type="number" name="orden" id="orden" class="form-control" readonly>
                </div>
              </div>

              <div class="col-md-3">
                <label for="fecha_vencimiento">Fecha de vencimiento <small><p class="obligatorio">*</p></small></label>
                <input type="text" data-provide="datepicker" name="fecha_vencimiento" id="fecha_vencimiento" class="form-control">
              </div>

              <div class="col-md-3">
                <div class="form-group">
                  <label for="verifico">Verificó <small><p class="obligatorio">*</p></small></label>
              ...
              <div class="col-md-12"></div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="des" id="labelDes">AC/Dependencia <small><p class="obligatorio">*</p></small></label>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label for="recomendacion_meta">Recomendación/Meta <small><p class="obligatorio">*</p></small></label>
                  <textarea name="recomendacion_meta" id="recomendacion_meta" class="form-control" style="min-width: 100%; max-width: 100%;  min-height: 115px;"></textarea>
                </div>
              </div>
              ...
              <div class="col-md-6" hidden>
                <div class="form-group">
                  <label for="ods_pdi">ODS PDI <small><p class="obligatorio">*</p></small></label>
                  <textarea name="ods_pdi" id="ods_pdi" class="form-control" style="min-width: 100%; max-width: 100%; min-height: 115px;"></textarea>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="estrategias">Estrategias PDI<small><p class="obligatorio">*</p></small></label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="meta_pdi">Meta PDI<small><p class="obligatorio">*</p></small></label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" name="indicador_pdi" id="indicador_pdi" class="form-control">
                </div>
              </div>
              <div class="col-md-12"></div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="ambito_siemec">Ámbito SEAES <small><p class="obligatorio">*</p></small></label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="criterio_siemec">Criterio SEAES <small><p class="obligatorio">*</p></small></label>
              ...
              <div class="col-md-12" style="display: flex; justify-content: flex-end;">
                <button class="btn btn-success" id="btn_edita" onclick="event.preventDefault(); guardaCambios(); this.disabled=true;">Guardar Nuevo registro</button>
              </div>
            </form>
...
<script>
    ...
    const tipoProcedencia = async (valor) => {
      const response = await fetch(`${ base_url }/admin/get/siglas-procedencia/${ valor }`, {
          method: 'get',
      });
