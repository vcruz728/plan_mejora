        ...
        <div class="box-body" style="padding-top: 2rem;">
          <div class="row">
              ...
              <div class="col-md-12"></div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="des">@if($plan->tipo_mejora == 2) Dependencia @else AC @endif <small><p class="obligatorio">*</p></small></label>
                ...
                <div id="div_des" @if($plan->tipo_mejora == 2) hidden @endif>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="unidad_academica">Unidad académica <small><p class="obligatorio">*</p></small></label>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="sede">Sede<small><p class="obligatorio">*</p></small></label>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="programa_educativo">Programa educativo<small><p class="obligatorio">*</p></small></label>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="nivel">Nivel<small><p class="obligatorio">*</p></small></label>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="modalidad">Modalidad<small><p class="obligatorio">*</p></small></label>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <textarea name="objetivo_pdi" id="objetivo_pdi" class="form-control" style="min-width: 100%; max-width: 100%;  min-height: 115px;" disabled>{{ $plan->objetivo_pdi }}</textarea>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <textarea name="estrategias" id="estrategias" class="form-control" style="min-width: 100%; max-width: 100%;  min-height: 115px;" disabled>{{ $plan->estrategia }}</textarea>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <textarea name="meta_pdi" id="meta_pdi" class="form-control" style="min-width: 100%; max-width: 100%;  min-height: 115px;" disabled>{{ $plan->meta }}</textarea>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <textarea name="indicador_pdi" id="indicador_pdi" class="form-control" style="min-width: 100%; max-width: 100%;  min-height: 115px;" disabled>{{ $plan->indicador_pdi }}</textarea>
                </div>
              </div>
              <div class="col-md-12"></div>
          ...
          <div class="row" style="margin-top: 1rem;">
            <div class="col-md-12">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="indicador_clave">Indicador clave <small><p class="obligatorio">*</p></small></label>
                  <input type="text" name="indicador_clave" id="indicador_clave" class="form-control" value="{{ $complemento?->indicador_clave }}">
                </div>
              </div>
            ...
            <div class="col-md-12" style="display: flex; justify-content: flex-end;">
              <button class="btn btn-primary" onclick="abreModal()"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;Agregar acción</button>
            </div>
          ...
          <div class="row" style="margin-top: 1rem;">
            <form id="form_guarda_complemento">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="logros">Logros <small><p class="obligatorio">*</p></small></label>
                  <input type="text" name="logros" id="logros" class="form-control" value="{{ $complemento?->logros }}">
                </div>
              </div>

              <div class="col-md-4">
                <div class="form-group">
                  <label for="impactos">Impactos <small><p class="obligatorio">*</p></small></label>
                  <input type="text" name="impactos" id="impactos" class="form-control" value="{{ $complemento?->impactos }}">
                </div>
              </div>

              <div class="col-md-4">
                <div class="form-group">
                  <label for="evidencia">Evidencia <small><p class="obligatorio">*</p></small></label>
                  <input type="file" name="evidencia" id="evidencia" class="form-control" accept=".pdf">
                </div>
                <div id="archivo_com">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea name="observaciones" id="observaciones" class="form-control" style="min-width: 100%; max-width: 100%;" placeholder="Máximo 600 caracteres">{{ $complemento?->observaciones }}</textarea>
                </div>
              </div>

              <div class="col-md-12" style="display: flex; justify-content: flex-end;">
                <button class="btn btn-success" id="btn_guardaComplemento" onclick="guardaComplemento(); this.disabled=true;">Guardar evidencia final</button>
              </div>
            </form>
          </div>
  ...
  <div class="modal-dialog" role="document" >
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title">Agregar acción de mejora <small style="color: #DDDDDD;"><p style="color: red; display: inline;">*</p>campos obligatorios</small></h3>
      ...
      <div class="modal-body">
        <div class="row">
          <form id="form_agrega_accion">
            <div class="col-md-12">
              <div class="form-group">
                <label for="accion">Acción <small><p class="obligatorio">*</p></small></label>
                <textarea name="accion" id="accion" class="form-control" style="min-width: 100%; max-width: 100;" placeholder="Máximo 500 caracteres"></textarea>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
                <label for="producto_resultado">Resultado <small><p class="obligatorio">*</p></small></label>
                <textarea name="producto_resultado" id="producto_resultado" class="form-control" style="min-width: 100%; max-width: 100%;" placeholder="Máximo 500 caracteres"></textarea>
              </div>
            </div>

            <div class="col-md-6">
              <div class="form-group">
                <label for="fecha_inicio">Fecha de inicio <small><p class="obligatorio">*</p></small></label>
                <input type="text" data-provide="datepicker" autocomplete="off" name="fecha_inicio" id="fecha_inicio" class="form-control">
              </div>
            </div>

            <div class="col-md-6">
              <div class="form-group">
                <label for="fecha_fin">Fecha de termino <small><p class="obligatorio">*</p></small></label>
                <input type="text" data-provide="datepicker" autocomplete="off" name="fecha_fin" id="fecha_fin" class="form-control">
              </div>
            </div>

            <div class="col-md-12">
              <div class="form-group">
                <label for="responsable">Respnosable <small><p class="obligatorio">*</p></small></label>
        ...
        <div class="modal-footer" id="container_btns_modal_confirmacion">
          ...
          <button type="button" class="btn btn-primary" id="btn_agregaAccion" onclick="agregaAccion(); this.disabled=true;">Guardar acción</button>
        </div>
      </div>
  ...
  <div class="modal-dialog" role="document" >
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <form id="form_edita_accion">
            <div class="col-md-12 esconde">
              <div class="form-group">
                ...
                <textarea name="accion_edit" id="accion_edit" class="form-control" style="min-width: 100%; max-width: 100;" placeholder="Máximo 500 caracteres"></textarea>
              </div>
            </div>
            <div class="col-md-12 esconde">
              <div class="form-group">
                <label for="producto_resultado_edit">Resultado</label>
                <textarea name="producto_resultado_edit" id="producto_resultado_edit" class="form-control" style="min-width: 100%; max-width: 100%;" placeholder="Máximo 500 caracteres"></textarea>
              </div>
            </div>
            ...
            <div class="col-md-6 esconde">
              <div class="form-group">
                ...
                <input type="text" data-provide="datepicker" autocomplete="off" name="fecha_inicio_edit" id="fecha_inicio_edit" class="form-control">
              </div>
            </div>
            ...
            <div class="col-md-6 esconde">
              <div class="form-group">
                ...
                <input type="text" data-provide="datepicker" autocomplete="off" name="fecha_fin_edit" id="fecha_fin_edit" class="form-control">
              </div>
            </div>

            <div class="col-md-12 esconde">
              <div class="form-group">
                <label for="responsable_edit">Respnosable <small><p class="obligatorio">*</p></small></label>
                <input type="text" name="responsable_edit" id="responsable_edit" class="form-control">
              </div>
            </div>
        ...
        <div class="modal-footer" id="container_btns_modal_confirmacion">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
          <button type="button" class="btn btn-primary" id="btn_editaAccion" onclick="editaAccion(); this.disabled=true;">Actualizar acción</button>
        </div>
      </div>
...
<script>
        ...
        if(data.code == 200){
          const table = $("#tabla_acciones").DataTable({
            ...
            columns: [
                ...
                { title: "Resultado", data: 'producto_resultado' },
    ...
    const guardaComplemento = async() => {
      ...
      if (data.code == 200) {
        ...
        $("#archivo_com").html(`<a href="${base_url}/storage/${data.archivo}" target="_BLANK">Ver archivo</a>`)
