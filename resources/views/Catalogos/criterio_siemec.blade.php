  ...
  <div class="modal-dialog" role="document">
      <div class="modal-content">
              ...
              <form id="form_edita_criterio">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="criterio_edit" id="criterio_edit" class="form-control" placeholder="Máximo 50 caracteres...">
                  </div>
                </div>
          ...
          <div class="modal-footer" id="container_btns_modal_confirmacion">
              ...
              <button type="button" class="btn btn-success" id="btn_edita" onclick="editaCriterio()">Guardar cambios</button>
          </div>
      </div>
  </div>
</div>
  ...
  <div class="modal-dialog" role="document">
      <div class="modal-content">
              ...
              <form id="form_nuevo_criterio">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="criterio" id="criterio" class="form-control" placeholder="Máximo 50 caracteres...">
                  </div>
                </div>
          ...
          <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
              <button type="button" class="btn btn-success" id="btn_guarda" onclick="guardaCriterio(); this.disabled=true;">Guardar</button>
          </div>
      </div>
  </div>
</div>
...
<script>
    ...
    const getCriterios = async () => {
      ...
      const table = $("#tabla_usuarios").DataTable({
        ...
        columns: [
          { title: "Criterio SIEMEC", data: 'descripcion' },
          {
