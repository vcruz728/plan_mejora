          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group" style="display: flex; justify-content: flex-end;">
                  <button class="btn btn-primary btn-sm mt-3" data-toggle="modal" data-target="#modal_agrega_consultor">Nueva Consultor <i class="fa fa-plus-circle"></i></button>
              </div>
          </div>
  ...
  <div class="modal-dialog" role="document">
      <div class="modal-content">
          ...
          <div class="modal-footer" id="container_btns_modal_confirmacion">
              ...
              <button type="button" class="btn btn-success" id="btn_guarda" onclick="guardaUsuario(); this.disabled=true;">Agregar</button>
          </div>
      </div>
  </div>
</div>
...
<div class="modal fade" id="modal_edita_usuario" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog" role="document">
      <div class="modal-content">
          ...
          <div class="modal-footer" id="container_btns_modal_confirmacion">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
              <button type="button" class="btn btn-primary" id="btn_guarda" onclick="reseteaPassword()">Resetear contraseña</button>
              <button type="button" class="btn btn-success" id="btn_guarda" onclick="editaUsuario()">Guardar cambios</button>
          </div>
      </div>
  </div>
</div>
