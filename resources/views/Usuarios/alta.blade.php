          ...
          <div class="row">
            <form id="form_alta_usuario">
              ...
              <div class="col-md-12" style="display: flex; justify-content: flex-end;">
                <button class="btn btn-success" id="btn_guarda" onclick="event.preventDefault(); guardaUsuario(); this.disabled=true;">Agregar nuevo usuario</button>
              </div>
            </form>
...
<script>
    ...
    const guardaUsuario = async() => {
      ...
      const response = await fetch(`${ base_url }/admin/guarda/nuevo/usuario`, {
          method: 'post',
          body,
          headers: {
